    ...
    public static void updateFinancialAid(FinancialAidBean financialAidBean, String group){
        ...
        try {
            if(financialAidBean.getAidAppType()!=""){
                MainPage.clickOptionList(By.cssSelector(aidAppTypeElement(group)),financialAidBean.getAidAppType(),By.cssSelector(PersonPage.SELECT_DROP));
            }
            if(financialAidBean.getStatus()!=""){
                MainPage.clickOptionList(By.cssSelector(statusElement(group)),financialAidBean.getStatus(),By.cssSelector(PersonPage.SELECT_DROP));
            }
