...
Feature: Actions Edit actions
  ...
  Scenario: Letter - create from template - system actions
    ...
    When I create a person
      |FirstName  |LastName     |Address1           |City       |State      |PostalCode|Country       |Role1  |StudentType|StudentStatusCategory|StudentStatus    |StudentStatusDate|EntryTerm|TemplateName             |TemplateDescription                  |RecordType|LetterName              |LetterFormat                   |LetterContent                        |Category       |Action                       |Comments                                 |SmartSearch|SingleRecipient  |
