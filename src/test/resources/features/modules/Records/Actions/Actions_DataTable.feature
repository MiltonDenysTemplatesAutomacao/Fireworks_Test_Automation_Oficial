...
Feature: Actions Edit actions
  ...
  Scenario: Letter - create from template - system actions
    ...
    When I create a person
      |FirstName  |LastName     |Address1           |City       |State      |PostalCode|Country       |Role1  |StudentType|StudentStatusCategory|StudentStatus    |StudentStatusDate|EntryTerm|TemplateName             |TemplateDescription                  |RecordType|LetterName              |LetterFormat                   |LetterContent                        |Category       |Action                       |Comments                                 |
      |Alfred     |Hitchcock    |10957 Bellagio Road|Los Angeles|California |90077     |United States |Student|Graduate   |Accepted             |Accepted         |01/15/2020       |Fall 2020|Template Actions Test1065|Letter Template description test 1065|Person    |Letter from Template1065|Letter (8.5 x 11 no letterhead)|Content for Letter from Template1065 |Campus Events  |Admitted Student Day: Attend |Template comment Letter from Template1065|
