...
Feature: School Without Scores
  ...
  Scenario: Record - Education_School-Transcript-Scores - verify scores are not required to add a school and transcript to a student record
    ...
    When I create a person
      |FirstName  |LastName     |EmailAddress           |EmailType|EmailOptInMethod |Role1   |StudentType|StudentStatusCategory |StudentStatus  |StudentStatusDate|EntryTerm|TranscriptType |
      |Gabriel    |Batistuta    |gbatistuta@futbol.net  |Personal |Inquiry          |Student |Freshman   |Accepted              |Accepted       |01/16/2016       |Fall 2017|Final          |
