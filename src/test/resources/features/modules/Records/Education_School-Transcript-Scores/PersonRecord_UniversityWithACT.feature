...
Feature: University with ACT
  ...
  Scenario: Record - Education_School-Transcript-Scores - verify a university and act score can be added to a student record
    ...
    And I create an organization
      ...
      |Rosebudgardner University |Post-Secondary Institution |621 Rose Drive  |San Carlos |California|94070      |United States  |CEEB   |69178    |05/11/2020  |Fire Starter |
    ...
    #And I verify score on Education for person "ACT", "21", "11/11/2012", "Score Report", "", "Score comment", "English", "20", "Mathematics", "22", "Reading", "19", "Science", "23", "Writing", "21" group "0"
