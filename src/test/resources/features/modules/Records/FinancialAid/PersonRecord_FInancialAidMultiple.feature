...
Feature: Financial Aid Multiple records can be added
  ...
  Scenario: Record - Financial Aid - verify two financial aid records can be added to a student record
    ...
    And I verify financial Aid "Scholarship", "Awarded", "Fall 2018", "2", "246866.00", "07/07/2017", "9", "85" group "0"
    And I verify Financial Aid Component "Application", "Yes", "08/01/2017", "Yes", "Aid Application1 Component1 comment" Financial "0" Aid "0"
    And I verify Financial Aid Component "Audition Tape", "Yes", "08/02/2017", "Yes", "Aid Application1 Component2 comment" Financial "0" Aid "1"
    And I verify Award Component "246766.00", "Institutional", "Grant", "Aid Award Component2 comment" Financial "0" Award Component "0"
    And I verify Award Component "100", "Government Grant", "Pell Grant", "Aid Award Component1 comment" Financial "0" Award Component "1"
    And I verify financial Aid "Need-Based", "Awarded", "Fall 2018", "1", "250.00", "08/07/2017", "9", "85" group "1"
    And I verify Financial Aid Component "FAFSA", "Yes", "08/07/2017", "Yes", "Aid Application2 Component1 comment" Financial "1" Aid "0"
    And I verify Financial Aid Component "CSS/PROFILE", "Yes", "08/08/2017", "Yes", "Aid Application2 Component2 comment" Financial "1" Aid "1"
    And I verify Financial Aid Component "Parental Tax Forms", "Yes", "08/09/2017", "Yes", "Aid Application2 Component3 comment" Financial "1" Aid "2"
    And I verify Financial Aid Component "Student Tax Forms", "Yes", "08/10/2017", "Yes", "Aid Application2 Component4 comment" Financial "1" Aid "3"
    And I verify Financial Aid Component "Institutional Aid Form", "Yes", "08/11/2017", "Yes", "Aid Application2 Component5 comment" Financial "1" Aid "4"
    And I verify Financial Aid Component "Financial Aid Transcript", "Yes", "08/12/2017", "Yes", "Aid Application2 Component6 comment" Financial "1" Aid "5"
    And I verify Award Component "250.00", "Loans", "Perkins", "Aid Award Component comment" Financial "1" Award Component "0"
    And I verify Financial Aid Interest "Athletic", "Soccer", "Yes", "07/01/2017" group "0"
    And I verify FinancialAidPayment "08/10/2017 12:00 AM", "999.99", "Application", "Credit Card", "Fire Starter", "Aid Payment comment" group "0"
