...
Feature: Multiple roles can be assigned
  ...
  Scenario: to verify merging an existing person with an incoming student
    ...
    And I create a person
     ...
     |Isao     |Takahata   |2iTakahata@japanesedirectors.com |Personal   |Inquiry           |Donor  |(904) 725-0002|Home     |141 Green Hill Dr |Buffalo|New York |14215     |United States |
    And I validate if "Person has been created" message is correct
    And I create a person
      |Firstname|Lastname   |EmailAddress		             |EmailType  |EmailOptInMethod	|Role1	|Role2  |Phone         |PhoneType|Address1          |City   |State    |PostalCode|Country       |StudentType|StudentStatusCategory|StudentStatus  |StudentStatusDate|EntryTerm|
      |Isao     |Takahata   |iTakahata@japanesedirectors.com |Personal   |Inquiry          |Sibling|Student|(904) 725-0002|Home     |141 Green Hill Dr |Buffalo|New York |14215     |United States |Freshman   |Inquiry              |Inquiry-Active |01/25/2016       |Fall 2017|
